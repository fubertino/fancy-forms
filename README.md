...
*    Publish your form:
    Once your form is ready, click "Publish" to make it available to users. You can share the form link or embed it on your website.
...
1. **Search for existing issues:** Before opening a new issue, please check the existing issues to see if your problem or feature request has already been reported.
...
Thank you for using Fancy-Form! We hope it helps you create and manage your forms effortlessly.